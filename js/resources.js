...
var PieceVal= [ 0, 100, 300, 315, 500, 1000, 50000, 100, 310, 315, 500, 1000, 50000  ];
...
var CAPTURE_AUDIO = document.getElementById("CaptureAudio");
var MOVE_AUDIO = document.getElementById("MoveAudio");

var OPENING_BOOK_PATH = "/book.json"

var BookLoaded = BOOL.FALSE;
