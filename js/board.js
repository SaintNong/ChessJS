...
GameBoard.pieces = new Array(GameBoard.SQ_NUM);
...
function BookMove() {
	...
	console.log("Book Move Found " + PrMove(bookMoves[num]))
...
function GeneratePosKey() {
	...
	for(sq = 0; sq < GameBoard.SQ_NUM; ++sq) {
		piece = GameBoard.pieces[sq];
...
function ResetBoard() {
	...
	for(index = 0; index < GameBoard.SQ_NUM; ++index) {
